...
const TOP_BRANDS = [
    ...
    },
    {
        ...
        description: 'American technology company developing, selling, repairing, and supporting computers and related products.'
    },
    {
        id: 'brd-lg',
        name: 'LG',
        logo: 'images/brandlogos/lglogo.webp',
        description: 'South Korean multinational electronics company producing home appliances, mobile devices, and TVs.'
    },
    {
        id: 'brd-philips',
        name: 'Philips',
        logo: 'images/brandlogos/philipslogo.webp',
        description: 'Diversified technology company focused on health and well-being, consumer lifestyle, and lighting.'
    },
    {
        id: 'brd-nike',
        name: 'Nike',
        logo: 'images/brandlogos/nikelogo.webp',
        description: 'World-renowned American multinational corporation designing, developing, manufacturing, and marketing footwear, apparel, equipment, accessories, and services.'
    },
    {
        id: 'brd-adidas',
        name: 'Adidas',
